...
export type RightPanelTab = 'code' | 'chat' | 'processes';
...
interface AppState {
  ...
  mobileView: 'graph' | 'filetree' | 'chat' | 'processes' | 'ai';
  setMobileView: (view: 'graph' | 'filetree' | 'chat' | 'processes' | 'ai') => void;
}
...
export const AppStateProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [mobileView, setMobileView] = useState<'graph' | 'filetree' | 'chat' | 'processes' | 'ai'>('graph');
