...
export const StatusBar = () => {
  ...
  return (
    <footer className="hidden sm:flex items-center justify-between px-4 sm:px-5 py-2 glass border-t border-border-subtle text-[11px] text-text-muted">
      <div className="flex items-center gap-4">
        {progress && progress.phase !== 'complete' ? (
          <>
            <div className="w-24 sm:w-28 h-1 glass rounded-full overflow-hidden">
              <div
